package com.housewife.terminal.filepicker;
...
public class TermuxDocumentsProvider extends DocumentsProvider {
    ...
    public Cursor queryRoots(String[] projection) {
        ...
        row.add(Root.COLUMN_ICON, android.R.drawable.sym_def_app_icon);
        return result;
    }
    ...
    private void includeFile(MatrixCursor result, String docId, File file)
        ...
        row.add(Document.COLUMN_ICON, android.R.drawable.sym_def_app_icon);
    }
