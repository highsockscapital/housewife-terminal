...
import static com.housewife.terminal.shared.termux.TermuxConstants.TERMUX_PREFIX_DIR;
import static com.housewife.terminal.shared.termux.TermuxConstants.TERMUX_PREFIX_DIR_PATH;
import static com.housewife.terminal.shared.termux.TermuxConstants.TERMUX_STAGING_PREFIX_DIR;
import static com.housewife.terminal.shared.termux.TermuxConstants.TERMUX_STAGING_PREFIX_DIR_PATH;
...
final class TermuxInstaller {
    ...
    static void setupBootstrapIfNeeded(final Activity activity, final Runnable whenDone) {
        ...
        if (FileUtils.directoryFileExists(TERMUX_PREFIX_DIR_PATH, true)) {
            if (TermuxFileUtils.isTermuxPrefixDirectoryEmpty()) {
            ...
            } else if (HousewifeInstaller.isInstallNeeded()) {
                ...
                new Thread() {
                    ...
                    public void run() {
                        try {
                            Error error = HousewifeInstaller.setupGlibcPrefix(activity);
                            if (error != null) {
        ...
        new Thread() {
            ...
            public void run() {
                try {
                    ...
                    if (com.housewife.terminal.shared.termux.TermuxBootstrap.isAppPackageVariantGlibcAndroid15()) {
                        Error glibcError = HousewifeInstaller.setupGlibcPrefix(activity);
                        if (glibcError != null) {
        ...
        new Thread() {
            public void run() {
                try {
                    ...
                    // Create "Android/data/<package>" symlinks
                    ...
                    // Create "Android/media/<package>" symlinks
