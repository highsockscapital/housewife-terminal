...
import com.housewife.terminal.shared.termux.terminal.io.BellHandler;
import com.housewife.terminal.shared.logger.Logger;
import com.housewife.terminal.terminal.TerminalColors;
import com.housewife.terminal.terminal.TerminalSession;
import com.housewife.terminal.terminal.TerminalSessionClient;
import com.housewife.terminal.terminal.TextStyle;
...
public class TermuxTerminalSessionActivityClient extends TermuxTerminalSessionClientBase {
    ...
    private synchronized void loadBellSoundPool() {
        if (mBellSoundPool == null) {
            ...
            try {
                mBellSoundId = mBellSoundPool.load(mActivity, com.housewife.terminal.shared.R.raw.bell, 1);
            } catch (Exception e){
                // Catch java.lang.RuntimeException: Unable to resume activity {com.housewife.terminal/com.housewife.terminal.app.TermuxActivity}: android.content.res.Resources$NotFoundException: File res/raw/bell.ogg from drawable resource ID
