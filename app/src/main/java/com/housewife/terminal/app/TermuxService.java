...
import com.housewife.terminal.app.event.SystemEventReceiver;
import com.housewife.terminal.app.terminal.TermuxTerminalSessionActivityClient;
import com.housewife.terminal.app.terminal.TermuxTerminalSessionServiceClient;
import com.housewife.terminal.shared.termux.plugins.TermuxPluginUtils;
import com.housewife.terminal.shared.data.IntentUtils;
import com.housewife.terminal.shared.net.uri.UriUtils;
import com.housewife.terminal.shared.errors.Errno;
import com.housewife.terminal.shared.shell.ShellUtils;
import com.housewife.terminal.shared.shell.command.runner.app.AppShell;
...
import com.housewife.terminal.shared.termux.shell.TermuxShellUtils;
...
import com.housewife.terminal.shared.termux.TermuxConstants.TERMUX_APP.TERMUX_SERVICE;
import com.housewife.terminal.shared.termux.settings.preferences.TermuxAppSharedPreferences;
import com.housewife.terminal.shared.termux.shell.TermuxShellManager;
...
import com.housewife.terminal.shared.shell.command.ExecutionCommand.ShellCreateMode;
import com.housewife.terminal.terminal.TerminalEmulator;
...
public final class TermuxService extends Service implements AppShell.AppShellClient, TermuxSession.TermuxSessionClient {
    ...
    private synchronized void killAllTermuxExecutionCommands() {
        ...
        for (int i = 0; i < pendingPluginExecutionCommands.size(); i++) {
            ...
            if (!executionCommand.shouldNotProcessResults() && executionCommand.isPluginExecutionCommandWithPendingResult()) {
                if (executionCommand.setStateFailed(Errno.ERRNO_CANCELLED.getCode(), this.getString(com.housewife.terminal.shared.R.string.error_execution_cancelled))) {
    ...
    private Notification buildNotification() {
        ...
        // FLAG_IMMUTABLE: intents are never mutated after creation (required on API 31+).
